...
template
void MatrixTimesVectorPlusVector<double>(const Teuchos::RCP<Plato::CrsMatrixType> &,
...
template
void VectorTimesMatrixPlusVector<double>(const Plato::ScalarVectorT<double> &,
