...
PLATO_ELEMENT_DEC(Plato::Elliptic::MassPropertiesFunction, Plato::Thermal)
PLATO_ELEMENT_DEC(Plato::Elliptic::MassPropertiesFunction, Plato::Mechanics)
PLATO_ELEMENT_DEC(Plato::Elliptic::MassPropertiesFunction, Plato::Thermomechanics)
PLATO_ELEMENT_DEC(Plato::Elliptic::MassPropertiesFunction, Plato::Electromechanics)
