...
namespace Elliptic
{
    ...
    **********************************************************************************/
    ...
    void CriterionEvaluatorLeastSquares<PhysicsType>::initialize (
    ...
    **********************************************************************************/
    template<typename PhysicsType>
    CriterionEvaluatorLeastSquares<PhysicsType>::CriterionEvaluatorLeastSquares(
    ...
    **********************************************************************************/
    template<typename PhysicsType>
    void CriterionEvaluatorLeastSquares<PhysicsType>::appendFunctionWeight(Plato::Scalar aWeight)
    {
    ...
    **********************************************************************************/
    template<typename PhysicsType>
    Plato::Scalar CriterionEvaluatorLeastSquares<PhysicsType>::
    ...
    **********************************************************************************/
    template<typename PhysicsType>
    Plato::ScalarVector CriterionEvaluatorLeastSquares<PhysicsType>::
    ...
    **********************************************************************************/
    template<typename PhysicsType>
    std::string CriterionEvaluatorLeastSquares<PhysicsType>::
    name() const
    {
