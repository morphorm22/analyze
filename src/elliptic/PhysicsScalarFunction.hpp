...
PLATO_ELEMENT_DEC(Plato::Elliptic::PhysicsScalarFunction, Plato::Thermal)
PLATO_ELEMENT_DEC(Plato::Elliptic::PhysicsScalarFunction, Plato::Mechanics)
PLATO_ELEMENT_DEC(Plato::Elliptic::PhysicsScalarFunction, Plato::Electromechanics)
PLATO_ELEMENT_DEC(Plato::Elliptic::PhysicsScalarFunction, Plato::Thermomechanics)
