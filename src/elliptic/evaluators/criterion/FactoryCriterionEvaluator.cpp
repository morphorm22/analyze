...
PLATO_ELEMENT_DEF(Plato::Elliptic::FactoryCriterionEvaluator, Plato::Elliptic::Nonlinear::Mechanics)
PLATO_ELEMENT_DEF(Plato::Elliptic::FactoryCriterionEvaluator, Plato::Elliptic::Nonlinear::ThermoMechanics)
