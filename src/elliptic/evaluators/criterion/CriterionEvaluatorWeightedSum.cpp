...
PLATO_ELEMENT_DEF(Plato::Elliptic::CriterionEvaluatorWeightedSum, Plato::Elliptic::Nonlinear::Mechanics)
PLATO_ELEMENT_DEF(Plato::Elliptic::CriterionEvaluatorWeightedSum, Plato::Elliptic::Nonlinear::ThermoMechanics)
