...
PLATO_ELEMENT_DEF(Plato::Elliptic::CriterionEvaluatorDivision, Plato::Elliptic::Nonlinear::Mechanics)
PLATO_ELEMENT_DEF(Plato::Elliptic::CriterionEvaluatorDivision, Plato::Elliptic::Nonlinear::ThermoMechanics)
