...
/// @class BoundaryEvaluatorTrialKirchhoffStress
...
class BoundaryEvaluatorTrialKirchhoffStress : public Plato::BoundaryFluxEvaluator<EvaluationType>
{
private:
...
public:
  ...
  BoundaryEvaluatorTrialKirchhoffStress(
