...
TEUCHOS_UNIT_TEST(PlatoAnalyzeUnitTests, MassPropertiesValue3D) {
  ...
  Plato::Scalar tGoldValue = 2.0 * pow((0.4 - 0.2) / 0.2, 2) + 0.1 * pow((0.5 - 0.05), 2) + 2.0 * pow((0.5 - 0.55), 2) +
                             3.0 * pow((0.5 - 0.75), 2) + 4.0 * pow((0.2666666 - 0.5) / 0.5, 2) +
                             5.0 * pow((0.2666666 - 0.5) / 0.5, 2) + 6.0 * pow((0.2666666 - 0.5) / 0.5, 2) +
...
TEUCHOS_UNIT_TEST(PlatoAnalyzeUnitTests, MassPropertiesValue3DNormalized) {
  ...
  Plato::Scalar tGoldValue =
      2.0 * pow((0.4 - 0.2) / 0.2, 2) + 0.1 * pow((0.5 - 0.05), 2) + 2.0 * pow((0.5 - 0.55), 2) +
      3.0 * pow((0.5 - 0.75), 2) + 4.0 * pow((-1.0589e-01 - 5.1241) / 5.1241, 2) +
      5.0 * pow((2.6130e-02 - 5.4403) / 5.4403, 2) + 6.0 * pow((1.8531e-01 - 5.3886) / 5.3886, 2) +
      7.0 * pow((1.9408e-04 - 0.0000) / 5.1241, 2) + 8.0 * pow((9.5366e-02 - 0.0000) / 5.1241, 2) +
