...
private:
  ...
  std::shared_ptr<Plato::Elliptic::BoundaryEvaluatorTrialIsotropicElasticStress<EvaluationType>> 
...
public:
    ...
    BaseClassType(aNitscheParams)
  {
    ...
    //
    mBoundaryStressEvaluator = 
      std::make_shared<Plato::Elliptic::BoundaryEvaluatorTrialIsotropicElasticStress<EvaluationType>>(
...
private:
  ...
  using StrainScalarType = typename Plato::fad_type_t<BodyElementBase,StateScalarType,ConfigScalarType>;
  /// @brief evaluates boundary trial and test stress tensors
  std::shared_ptr<Plato::Elliptic::BoundaryEvaluatorTestIsotropicElasticStress<EvaluationType>> 
    mBoundaryStressEvaluator;
...
public:
    ...
    BaseClassType(aNitscheParams)
  {
    ...
    //
    mBoundaryStressEvaluator = 
      std::make_shared<Plato::Elliptic::BoundaryEvaluatorTestIsotropicElasticStress<EvaluationType>>(
        aParamList,aNitscheParams
      );
  }
